...
('Chicken Breast', 'Boneless, skinless chicken breast', 'Proteins', 'Poultry', 165, 165, 31, 0, 0, 3.6, 0, 0, 74, 0.19, true, false, false, true, true, true, true, '{"piece", "gram", "pound"}', '{"chicken", "poultry", "protein", "meat"}', 'https://images.unsplash.com/photo-1604503468506-a8da13d82791?w=500', 'https://images.unsplash.com/photo-1604503468506-a8da13d82791?w=150', 'A', '1234567890123'),
('Quinoa', 'Ancient grain, high in protein', 'Grains', 'Ancient Grains', 368, 368, 14, 64, 64, 6, 7, 0, 5, 0.01, true, true, true, true, true, true, true, '{"cup", "gram", "pound"}', '{"quinoa", "grain", "protein", "gluten-free"}', 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=500', 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=150', 'A', '2345678901234'),
('Almonds', 'Raw almonds, high in healthy fats', 'Proteins', 'Nuts', 579, 579, 21, 22, 22, 50, 12, 4.4, 1, 0.003, true, true, true, true, true, true, true, '{"cup", "gram", "ounce", "piece"}', '{"almonds", "nuts", "healthy fats", "snack"}', 'https://images.unsplash.com/photo-1553909489-cd47e0ef937f?w=500', 'https://images.unsplash.com/photo-1553909489-cd47e0ef937f?w=150', 'C', '3456789012345'),
('Greek Yogurt', 'High protein yogurt', 'Dairy', 'Yogurt', 59, 59, 10, 3.6, 3.6, 0.4, 0, 3.6, 36, 0.09, true, false, true, true, false, true, true, '{"cup", "gram", "tbsp"}', '{"yogurt", "dairy", "protein", "probiotic"}', 'https://images.unsplash.com/photo-1571212056830-8e4d9d5e8b3b?w=500', 'https://images.unsplash.com/photo-1571212056830-8e4d9d5e8b3b?w=150', 'A', '4567890123456'),
('Olive Oil', 'Extra virgin olive oil', 'Pantry Staples', 'Oils', 884, 884, 0, 0, 0, 100, 0, 0, 2, 0.005, true, true, true, true, true, true, true, '{"tbsp", "cup", "ml"}', '{"olive oil", "healthy fat", "cooking oil"}', 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=500', 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=150', 'C', '5678901234567'),
('Spinach', 'Fresh spinach leaves', 'Vegetables', 'Leafy Greens', 23, 23, 2.9, 3.6, 3.6, 0.4, 2.2, 0.4, 79, 0.2, true, true, true, true, true, true, true, '{"cup", "gram", "bunch"}', '{"spinach", "leafy greens", "iron", "vegetables"}', 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=500', 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=150', 'A', '6789012345678')
